      ...
      {visible && (
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3">
            <RippleButton
              onClick={decline}
              className="px-4 py-2 bg-transparent border border-gray-500 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition"
            >
              Decline
            </RippleButton>
            <RippleButton
              onClick={accept}
              className="px-4 py-2 bg-brand-red  text-white rounded-md transition"
            >
              Accept
            </RippleButton>
          </div>
