...
export default function Footer() {
  return (
    <footer className="bg-[#1B1C1E]">
      <div className="mx-auto xl:px-20 px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex justify-center">
          <Image alt="logo" loading="lazy" width="136" height="46" decoding="async" data-nimg="1" style="color:transparent" src="/images/logonobg.png" />
        </div>
        <ul className="mt-12 grid grid-cols-2 md:flex items-center text-center justify-center gap-6 md:gap-8 w-full lg:gap-12 text-white">
          <a href="/services">Services</a>
          <a href="/provider">Providers</a>
          <a href="/contact">Contact Us</a>
          <a href="/privacy">Privacy Policy</a>
          <div className="col-span-2 md:col-span-1 flex justify-center ">
            <a className="text-center w-full" href="/term-conditions">Terms and Conditions</a>
          </div>
        </ul>
        <div>
          <p className="text-white text-xs text-center mt-8 mb-2">No 3 Lekki Phase 1, Lagos state</p>
        </div>
        <div className="mt-0 flex flex-col md:flex-row justify-between items-center text-white text-sm border-t w-full border-gray-700 pt-6">
          <p>© 2025 Latev Engineering Services Ltd. All rights reserved.</p>
